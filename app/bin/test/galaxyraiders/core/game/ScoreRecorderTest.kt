...
class ScoreRecorderTest {
    ...
    fun `it saves the score and updates the scoreboard and leaderboard`() {
        ...
        val scoreboardFile = File("./core/score/Scoreboard.json")
        val leaderboardFile = File("./core/score/Leaderboard.json")
